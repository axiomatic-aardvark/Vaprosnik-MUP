  ...
  const updateInDb = () => {
    axios
      .post(
        ...
        {
          option1: option1.endsWith("t") ? option1 : option1 + ",t",
          option2: option2.endsWith("f") ? option2 : option2 + ",f",
          option3: option3.endsWith("f") ? option3 : option3 + ",f",
          option4: option4.endsWith("f") ? option4 : option4 + ",f",
          text: text
        }
      )
