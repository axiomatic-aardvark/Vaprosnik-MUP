...
export default props => {
    ...
    const getRightAndWrongAnswers = ({ option1, option2, option3, option4, text }) => {
    ...
    const fetchQuestionFromDb = async () => {
        axios.get(`https://server-vaprosnik.herokuapp.com/questions/${givenId}`)
            .then((response) => {
    ...
    return (
        <div className="edit-by-id-container">
            ...
            <Form className="id-form" onSubmit={handleSubmitId}>
                ...
                <Button type="submit" className="btn" variant="primary">Зареди</Button>
            </Form>
